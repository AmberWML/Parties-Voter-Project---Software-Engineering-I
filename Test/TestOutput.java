...
public class TestOutput {
    public static void main(String args[]) {
        ...
        OutputFile f= new OutputFile("/Users/wangruohan/desktop/CSCI5801/Test/outputfile.txt");
        ...
        System.out.println("Does f.path == The path we have ?: " + (boolean) (f.path == "/Users/wangruohan/desktop/CSCI5801/Output/outputfile.txt"));
